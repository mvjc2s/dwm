...
static const Keychord *keychords[] = {
  ...
  &((Keychord){2, {{MODKEY, XK_f}, {0, XK_m}},                                   focusmaster,        {0} }),
  &((Keychord){2, {{MODKEY, XK_g}, {0, XK_t}},                                   togglegaps,         {0} }),
  &((Keychord){2, {{MODKEY, XK_g}, {0, XK_d}},                                   defaultgaps,        {0} }),
  &((Keychord){2, {{MODKEY, XK_g}, {0, XK_e}},                                   incrgaps,           {.i = +1 } }),
  &((Keychord){2, {{MODKEY, XK_g}, {ShiftMask, XK_e}},                           incrgaps,           {.i = -1 } }),
  &((Keychord){2, {{MODKEY, XK_g}, {0, XK_i}},                                   incrigaps,          {.i = +1 } }),
  &((Keychord){2, {{MODKEY, XK_g}, {ShiftMask, XK_i}},                           incrigaps,          {.i = -1 } }),
  &((Keychord){2, {{MODKEY, XK_g}, {0, XK_o}},                                   incrogaps,          {.i = +1 } }),
  &((Keychord){2, {{MODKEY, XK_g}, {ShiftMask, XK_o}},                           incrogaps,          {.i = -1 } }),
  &((Keychord){2, {{MODKEY, XK_h}, {0, XK_i}},                                   incrihgaps,         {.i = +1 } }),
  &((Keychord){2, {{MODKEY, XK_h}, {ShiftMask, XK_i}},                           incrihgaps,         {.i = -1 } }),
  &((Keychord){2, {{MODKEY, XK_h}, {0, XK_o}},                                   incrohgaps,         {.i = +1 } }),
  &((Keychord){2, {{MODKEY, XK_h}, {ShiftMask, XK_o}},                           incrohgaps,         {.i = -1 } }),
  &((Keychord){2, {{MODKEY, XK_v}, {0, XK_i}},                                   incrivgaps,         {.i = +1 } }),
  &((Keychord){2, {{MODKEY, XK_v}, {ShiftMask, XK_i}},                           incrivgaps,         {.i = -1 } }),
  &((Keychord){2, {{MODKEY, XK_v}, {0, XK_o}},                                   incrovgaps,         {.i = +1 } }),
  &((Keychord){2, {{MODKEY, XK_v}, {ShiftMask, XK_o}},                           incrovgaps,         {.i = -1 } }),
  ...
  &((Keychord){2, {{MODKEY, XK_w}, {0, XK_b}},                         setlayout,          {.v = &layouts[4] } }),      // layout[4]: bottom stack horizontal
  ...
  &((Keychord){2, {{MODKEY, XK_w}, {0, XK_period}},                    cyclelayout,        {.i = +1 } }),
  &((Keychord){2, {{MODKEY, XK_w}, {0, XK_comma}},                     cyclelayout,        {.i = -1 } }),
  &((Keychord){2, {{MODKEY, XK_w}, {0, XK_space}},                     togglefloating,     {0} }),
  &((Keychord){2, {{MODKEY, XK_w}, {ShiftMask, XK_m}},                 layoutmenu,         {0} }),
